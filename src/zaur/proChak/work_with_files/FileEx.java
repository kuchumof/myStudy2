...
public class FileEx {
    public static void main(String[] args) throws IOException {
        ...
        File file2 = new File("C:\\\\Users\\\\User\\\\Desktop\\A\\test22.txt");
        ...
        System.out.println("file2 isHidden()  "+file2.canRead());
        System.out.println("file2 isHidden()  "+file2.canWrite());
        System.out.println("file2 isHidden()  "+file2.canExecute());
        System.out.println("--------------------------------------------------------------------------------------------------------------------------------");
