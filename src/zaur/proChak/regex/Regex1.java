...
public class Regex1 {
    public static void main(String[] args) {
       ...
       // Pattern pattern1 = Pattern.compile("\\w+"); // все слова и цифры
        // Pattern pattern1 = Pattern.compile("\\b\\d{2}\\b"); // цифры из 2 сиболов
        // Pattern pattern1 = Pattern.compile("\\+\\d{9}"); // номера телефонов
         Pattern pattern1 = Pattern.compile("\\w+@\\w+\\.\\w+"); // е майлы
