package zaur.proChak.annotation_examples;

import java.lang.annotation.*;

public class Test2 {
    public static void main(String[] args) throws ClassNotFoundException {
        Class xiaomiClass = Class.forName("zaur.proChak.annotation_examples.Xiaomi");
        ...
        Class iphoneClass = Class.forName("zaur.proChak.annotation_examples.Iphone");
